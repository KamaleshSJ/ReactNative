...
import {
  ...
  useNavigation,
  useRoute,
} from "@react-navigation/native"; // Added NavigationProp import
        ...
        <View style={[]}>
          <View className="flex-row pl-6 pt-6 " style={{}}>
            ...
            <View className="pl-4 pt-4" style={{}}>
              ...
              <Text style={{}}>
                Status:{" "}
                <Text className="font-bold text-fuchsia-800" style={{}}>
                  Period
                </Text>
              </Text>
            </View>
            ...
            <TouchableOpacity
              onPress={() =>
                router.push("/(main)/(periodtracking)/notificationscreen")
              }
            >
              <MaterialCommunityIcons
                className="pl-44 pt-6"
                name="bell"
                size={24}
                color={styles.bellIcon?.color || "black"}
              />
            </TouchableOpacity>
          </View>
          ...
          <View
            className=" pt-36 w-full items-center "
            style={{
              width: screenWidth,
            }}
          >
          ...
          <View
            className="mt-36 justify-center "
            style={{
              width: "85%",
              height: rV(130),
          ...
          >
            ...
            <View className="flex-row ">
              ...
              <Image
                className="w-48 h-36 -mt-20  -ml-4"
                source={require("../../../../assets/images/little-girl-t-shirt.png")}
                style={{}}
              ></Image>
            </View>
          </View>
          ...
          <View style={styles.twoCardsContainer}>
            <LinearGradient
              colors={["rgba(140, 35, 83, 0.75)", "rgba(186, 103, 199, 0.25)"]}
              className="items-center justify-center"
              style={{
                width: "48%",
            ...
            >
              <View className="pl-5 " style={{}}>
                <Text className="" style={styles.feelingText}>
                  How are you {"\n"}Feeling today?
                </Text>
                <TouchableOpacity
                  onPress={() => alert("Will Create This Page Soon")}
                >
                  ...
                  >
                    <Text className="" style={styles.symptomstext}>
                      Symptoms
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
            ...
            <LinearGradient
              ...
              className="items-center justify-center"
              colors={["rgba(186, 103, 199, 0.75)", "rgba(140, 35, 83, 0.75)"]}
              style={{
                width: "48%",
